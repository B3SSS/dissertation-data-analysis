...
cursor.execute("""
    SELECT TO_CHAR(fp.date, 'YYYY') AS age, COUNT(*)
    FROM Fact_Patient AS fp
...
clickhouse_client.insert("aggregation_year_diseases", data=data, column_names=["year", "quantity"])